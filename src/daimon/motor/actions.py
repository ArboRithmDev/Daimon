...
ACTIONS: dict[str, ActionDef] = {
    ...
    "main_window_minimize": ActionDef("main_window_minimize", Level.NONDESTRUCTIVE, "minimize the target window", requires_observed_target=False),
    "main_window_hide": ActionDef("main_window_hide", Level.NONDESTRUCTIVE, "hide the target app", requires_observed_target=False),
    "main_window_show": ActionDef("main_window_show", Level.NONDESTRUCTIVE, "unhide + un-minimize + raise the target app", requires_observed_target=False),
